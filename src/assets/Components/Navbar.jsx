            ...
            <Menu placement="left-start">
              <MenuHandler>
                <Avatar
                  variant="circular"
                  alt="tania andrew"
                  className="cursor-pointer bg-bla"
              ...
              <MenuList >
                  ...
                  <Menu placement="left-bottom">
                    ...
                    <MenuList>
                      {userss.map((item) => {
                        return (
                          <div>
                            <MenuItem> EMAIL:{item.email}</MenuItem>
                            ...
                            <MenuItem>
                              {" "}
                              WISH LIST:{item.wishlist.length}
                            </MenuItem>
                          </div>
                        );
                      })}
                ...
                <MenuItem className="flex items-center gap-2 ">
                  ...
                  {users ? (
                    ...
                    >
                      <i
                        class="fa-solid fa-right-long fa-flip-horizontal"
                        style={{ color: "#aaaaaa" }}
                      ></i>
                    </div>
                  )}
        ...
        {ser.map((e)=>{
          ...
          return(
            ...
            key={e.id} className="flex w-[100%] bg-white text-black    ml-auto justify-between  rounded-md shadow-sm   items-center p-2 ">
              <div>{e.title}</div>
              <img src={e.image} alt=""  className="h-[100%] w-[100px] object-cover p-2 shadow-sm"/>
            </Link>
          )
        })}
        </div>}
